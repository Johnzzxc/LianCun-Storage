...
//SetFileId sets the fileId to the KeyValueMap
func (km *KeyValueMap) SetFileId(fileId string) {
	(*km)[kmFileId] = fileId
}
...
// ToKeyValue implementation for ListDealsArgs
func (args *ListDealsArgs) ToKeyValue() KeyValueMap {
	km := KeyValueMap{}
	km.SetFileId(string(args.FileId))
	km.SetBucket(args.BucketName)
	km.SetPrefix(args.Prefix)
	km.SetMarker(args.Marker)
	return km
...
// ToKeyValue implementation for SetBucketPolicyWebArgs
func (args *SetRetrieveArgs) ToKeyValue() KeyValueMap {
	km := KeyValueMap{}
	km.SetFileId(string(args.FileId))
	km.SetBucket(args.BucketName)
	km.SetPrefix(args.Prefix)
