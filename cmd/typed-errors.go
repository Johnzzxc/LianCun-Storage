...
// error returned when file not found.
var errFileNotFound_ = errors.New("文件不存在")

// error returned when file deal not found.
var errFileDealNotFound_ = errors.New("该文件暂未上链")

// error returned when file task not found.
var errFileTaskNotFound_ = errors.New("上链任务不存在")

// error returned when file retrieve not found.
var errFileRetrieveNotFound_ = errors.New("检索任务不存在")

// error returned when file retrieve is working.
var errFileRetrieveWorking_ = errors.New("任务执行中，请勿重复新增")
