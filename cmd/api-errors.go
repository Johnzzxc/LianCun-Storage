...
const (
	...
	ErrFileDealNotFound
	ErrFileTaskNotFound
	ErrFileRetrieveNotFound
	ErrFileRetrieveWorking
)
...
var errorCodes = errorCodeMap{
	...
	ErrFileTaskNotFound: {
		Code:           "FileTaskNotFound",
		Description:    "该上链任务不存在",
		HTTPStatusCode: http.StatusForbidden,
	},
	ErrFileRetrieveNotFound: {
		Code:           "FileRetrieveNotFind",
		Description:    "该文件检索不存在",
		HTTPStatusCode: http.StatusForbidden,
	},
}
...
func toAPIErrorCode(ctx context.Context, err error) (apiErr APIErrorCode) {
	...
	case errFileNotFound_:
		apiErr = ErrFileNotFound
	case errFileDealNotFound_:
		apiErr = ErrFileDealNotFound
	case errFileTaskNotFound_:
		apiErr = ErrFileTaskNotFound
	case errFileRetrieveNotFound_:
		apiErr = ErrFileRetrieveNotFound
	case errFileRetrieveWorking_:
		apiErr = ErrFileRetrieveWorking
